...
const experiences: Experience[] = [
  ...
  },
  {
    ...
    org: 'Pinterest',
    period: '2023 – 2025',
    bullets: ['Managed $30M annual SMB sales revenue, beat quota 3x', 'Built AI email flow → +10% advertiser reply rate'],
  },
  {
    id: 'canva',
...
const mobileTimelineItems = [
  ...
  {
    date: '2023-01-01',
    title: 'Senior Product Manager · Pinterest',
    items: ['Managed $30M annual SMB sales revenue, beat quota 3x', 'Built AI email flow → +10% advertiser reply rate'],
    logo: '/logos/pinterest.png',
    logoClassName: 'brightness-0 dark:invert',
  },
  {
    date: '2021-01-01',
    title: 'Technology Consultant · Accenture',
